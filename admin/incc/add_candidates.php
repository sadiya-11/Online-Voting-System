...
if (isset($_GET['added'])) {
    ...
    ?>
        <div class="alert alert-danger my-3" role="alert">
            Candidate image is too large, please upload a small file (You can upload upto 4mbs).....
        </div>
    <?php
        ...
        <form method="POST" enctype="multipart/form-data">
            <div class="form-group">
                <select class="form-control" name="election_id" required>
                    ...
                    <?php
                    $fetchingElections = mysqli_query($db, "SELECT * FROM elections WHERE status IN ('active', 'inactive')") or die(mysqli_error($db));
            ...
            <div class="form-group">
                <input type="text" name="voter_id" placeholder="Voter ID" class="form-control" required /> <!-- Voter ID Field -->
            </div>
        ...
        <table class="table">
            ...
            <tbody>
                ...
                if ($isAnyCandidateAdded > 0) {
                    ...
                    ?>
                    <tr>
                        <td colspan="7" style="color: white;">No any candidate added yet! </td>
                    </tr>
                    <?php
                }
                ?>
